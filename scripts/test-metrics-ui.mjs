...
assert.match(page, /\/api\/metrics\/content\.json\?/, 'dashboard fetches the JSON metric API endpoint generated by Astro');
assert.match(page, /Object\.values\(rawSeries\)/, 'dashboard normalizes API series objects before mapping');
