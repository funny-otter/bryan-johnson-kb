...
contested: true
summary: >-
  The Blueprint Protocol is bryan-johnson's closed-loop health system: measure
  body state, consult scientific evidence, implement interventions, measure
  again, and update. Johnson treats the body as a system whose organs a
---
# Blueprint Protocol

The Blueprint Protocol is [bryan johnson](/knowledge/bryan-johnson/)'s closed-loop health system: measure body state, consult scientific evidence, implement interventions, measure again, and update. Johnson treats the body as a system whose organs and biomarkers should have more authority than cravings or cultural defaults.
...
- [algorithmic health](/knowledge/algorithmic-health/) — the broader measurement-and-policy pattern behind the protocol.
