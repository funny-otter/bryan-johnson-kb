...
summary: >-
  ...
  deep-tech investing into a public, data-driven longevity experiment. His
  earlier identity is anchored in Braintree/Venmo, OS Fund, and Kernel: OS Fund
---
# Bryan Johnson
...
- [project blueprint](/knowledge/project-blueprint/) — Johnson's protocol, self-experiment, product ecosystem, and measurement methodology.
- [dont die](/knowledge/dont-die/) — the community/ideology that generalizes his health project into a civilizational slogan.
...
Use Johnson as a high-signal case study in [biomarker driven longevity protocols](/knowledge/biomarker-driven-longevity-protocols/), but keep claims separated into: (1) independently verifiable biography/business facts, (2) Johnson/Blueprint primary-source health claims, and (3) third-party scientific/medical interpretation. His transparency and measurement density are useful; the N=1 design, simultaneous intervention changes, commercial incentives, and reliance on surrogate biomarkers limit generalizability.
